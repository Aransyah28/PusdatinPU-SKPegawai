...
/**
 * Tabel Dokumen Laporan Keuangan.
 */
export const laporanKeuanganDocuments = sqliteTable("laporan_keuangan_document", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => crypto.randomUUID()),
  title: text("title").notNull(),
...
/**
 * Tabel Dokumen LPJ Bendahara.
 */
export const lpjBendaharaDocuments = sqliteTable("lpj_bendahara_document", {
  id: text("id")
    .primaryKey()
    .$defaultFn(() => crypto.randomUUID()),
  title: text("title").notNull(),
